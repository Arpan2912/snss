  ...
  return (
    <section id="about" className="about">
      <div className="container" data-aos="fade-up">
        ...
        <div className="row">
          <div className="col-lg-4 order-1 order-lg-2" data-aos="fade-left" data-aos-delay="100">
            <img src="assets/img/about.jpg" className="img-fluid" alt=""></img>
          </div>
          <div className="col-lg-8 pt-4 pt-lg-0 order-2 order-lg-1 content section-content" data-aos="fade-right" data-aos-delay="100">
            <div className="row">
      ...
      <div className="row mt-4" >
        <div className="col" style={{ backgroundColor: '#8d0506', color: 'white', marginTop: '60px' }}>
          {/* <p> */}
          <div className="motto">
            <div className="container" style={{ textAlign: 'center', padding: '35px', position: 'relative' }}>
