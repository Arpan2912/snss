          ...
          <div className="col-lg-6 col-md-6 d-flex align-items-stretch">
            <div className="member" data-aos="fade-up" data-aos-delay="100">
              ...
              <div className="member-info">
                ...
                <div>
                  <div>Niranjan Shah, founder of SNSS & Co is a Chartered accountant since 2010 and is a member of international tax committee of WIRC of ICAI for the year 2022-23. He is a registered valuer with IBBI and a member of Independent Director’s Databank with IICA</div>
                  <div className="mt-2">He has vast experience of more than a decade in the field of International Tax, Transfer pricing, FEMA consulting, Business Valuations, cross border structuring, advisory and litigation under direct tax etc. </div>
                  <div className="mt-2">He is contributor to the journals published by ICAI RVO and regularly write blogs on various subjects in profession</div>
                  <div className="mt-2">During the tenure of his professional career, he has been exposed to various clients having global presence across diversified sectors as well as advising to MNCs who wants to set up their business in India</div>
                  <div className="mt-2">He is also performing key role in the firms for Statutory Audit, Ind AS/IFRS consulting etc.</div>
                  {/* <ul>
          ...
          <div className="col-lg-6 col-md-6 d-flex align-items-stretch">
            <div className="member" data-aos="fade-up" data-aos-delay="200">
              ...
              <div className="member-info">
                ...
                <div>
                  <div>
                    <div>Sanyam Shah is qualified Chartered accountants since 2014 and has good experience in consulting and compliance for GST matters.</div>
                    <div className="mt-2">He has also advised small and medium enterprises in the field of GST and finance solutions</div>
                    <div className="mt-2">His key expertise includes CFO functions for SMEs, Financial Planning and GST solutions, commercial law matters, strategic business planning for service and trading companies as well as retail sector. He has been exposed to service entities operating in FMCG and retail industry</div>
                    {/* <ul>
